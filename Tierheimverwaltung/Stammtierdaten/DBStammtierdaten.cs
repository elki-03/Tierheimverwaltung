...
namespace Tierheimverwaltung
{
    public class DBStammtierdaten
    {
        ...
        //public int stammtierdatenID; --> nun globale Variable
        ...
        public static void Create(Stammtierdaten stammtierdaten)
        {
            ...
            try
            {
                ...
                //              "VALUES (@tiername, @tierart, @rasse, @beschreibung, @geschlecht, @kastriert, @groesse, @gewicht, @geburtstag, @geburtsort, @todestag, @todesursache, @ort, @notizenStammtierdaten, @stammtierdatenID);";
                //
